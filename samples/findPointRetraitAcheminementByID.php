...
use ColissimoPickupPoint\StructType\FindPointRetraitAcheminementByID;
 ...
 * Send the request
 */
$result = $find->findPointRetraitAcheminementByID(new FindPointRetraitAcheminementByID(COLISSIMO_WS_CONTRACT_NUMBER, COLISSIMO_WS_PASSWORD, '097297', date('d/m/Y'), '2'));
/**
