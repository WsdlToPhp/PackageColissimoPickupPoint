...
use ColissimoPickupPoint\StructType\FindRDVPointRetraitAcheminement;
 ...
 * Send the request
 */
$result = $find->findRDVPointRetraitAcheminement(new FindRDVPointRetraitAcheminement(COLISSIMO_WS_CONTRACT_NUMBER, COLISSIMO_WS_PASSWORD, '13 Rue de la Fédération', '75015', 'Paris', 'FR', '2', date('d/m/Y')));
/**
